...
- Allocation is contiguous: a service gets a block [start, start+width)
  that must be free on every link along its path. This matches the
  flexible-grid slot model of ITU-T G.694.1 and the per-link "available
  spectrum slots" abstraction used in optical-networking-gym
