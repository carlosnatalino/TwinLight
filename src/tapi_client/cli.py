...
Installed as the ``tapi-client`` console command (see pyproject.toml):

    tapi-client
    tapi-client --rest-url URL --gnmi-target HOST:PORT

Equivalently runnable as a module: ``python -m tapi_client``.
"""
